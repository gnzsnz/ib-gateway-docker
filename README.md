...
| --- | -------- | ------------------- | ---------------- | ---------------------------------------------- |
| [ib-gateway][1] | `latest` | `10.46.1f` | `3.23.0` | `latest` `10.46` `10.46.1f` |
| [ib-gateway][1] |`stable` | `10.45.1e` | `3.23.0` | `stable` `10.45` `10.45.1e` |
| [tws-rdesktop][2] | `latest` | `10.46.1f` | `3.23.0` | `latest` `10.46` `10.46.1f` |
| [tws-rdesktop][2] |`stable` | `10.45.1e` | `3.23.0` | `stable` `10.45` `10.45.1e` |
