...
Utility [socat](https://manpages.ubuntu.com/manpages/noble/en/man1/socat.1.html) is used to publish IB Gateway API ports from container's `127.0.0.1:4001/4002` to container's `0.0.0.0:4003/4004`. The sample `docker-compose.yml` maps these ports back to the host as `4001/4002`. This way any application can use the standard IB Gateway ports.
